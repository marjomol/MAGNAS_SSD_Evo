...
units module
Contains the basic units of the simulation code (MASCLET units by defoult).

Created by Marco Molina Pradillo, based on the work of David Vallés
"""
...
cgs_to_density = mass_to_g**(-1) * length_to_cm**(3)
...
energy_to_J = mass_to_kg**(1) * length_to_m**(2) * time_to_s**(-2)
energy_to_erg = mass_to_g**(1) * length_to_cm**(2) * time_to_s**(-2)
...
H0_isu = 100 * h # km/s/Mpc
a0_isu = 1 # Mpc
H0_masclet = 3.66 * 10**(-3) * h
a0_masclet = mpc_to_length
