...
Created by Óscar Monllor Berbegal for HALMA-MASCLET
"""
...
def main(box, level, ncoarse, L, npatch, patchnx, patchny, patchnz, patchrx, patchry, patchrz, field, verbose = False):
    ...
    which_patches = utils.which_patches_inside_box(box, patchnx, patchny, patchnz, patchrx, patchry, patchrz, npatch, L, ncoarse)
